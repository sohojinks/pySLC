import asyncore, socket, random, time, re, string, struct, array, platform, sys, getopt, logging, math
...
def HandleCLI(argv):
    ...
    try:
        opts, args = getopt.getopt(argv, "hr:sl:d:t:w:u:p:DV",["help","read=","store","length=","database=","table=","write=","user=","pass=","Debug","Verbose"])
...
def writeToSLC(IP,address,value):
    global _read
    global _address
    global _store
    global _database
